...
NEF_DEFAULT_DICT = os.path.join(NEF_ROOT_PATH, '../../NEF_SPECIFICATION/specification/mmcif_nef_v1_1.dic')
...
if __name__ == '__main__':
    ...
    filePath = os.path.join(os.getcwd(), 'NEF_SPECIFICATION', 'specification', infile)
